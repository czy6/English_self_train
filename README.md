...
英语智能训练平台是一个**微服务架构**的英语学习与训练系统，整合了 **Spring AI**、**LangChain4j**等先进技术，提供智能化的英语学习、训练、评测一体化解决方案。

项目采用**前后端分离** + **微服务架构** + **智能体**，实现了 AI 智能批改、个性化题目推荐、智能对话陪练等核心功能，支持 SSE 流式输出、对话记忆存储、用户学情分析等特性。

### 🎯 项目亮点

- ✨ **微服务架构**：基于 Spring Cloud Alibaba 的微服务拆分，Nacos 注册中心 + 配置中心
- 🤖 **AI 双引擎**：Spring AI + LangChain4j 双框架集成，支持 SSE 流式对话输出
- 🧠 **智能推荐**：基于机器学习模型的熟练度预测与个性化题目推荐
